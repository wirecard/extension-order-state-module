 ...
 * @coversDefaultClass \Wirecard\ExtensionOrderStateModule\Domain\UseCase\InitialPayment\Handler\Notification\Processing
 * @since 1.0.0
 */
class ProcessingTest extends \Codeception\Test\Unit
{
    ...
    protected function _setUp()
    {
        ...
        $this->handler = new Processing($this->initialProcessData);
    }
    ...
    public function ignorableScenariosDataProvider()
    {
        ...
        foreach ($scopeTypes as $scopeType) {
            yield "initial_notification_ignorable_{$scopeType}_on_processing_scope" =>
            [
                Constant::ORDER_STATE_PENDING,
                $scopeType,
    ...
    public function testCalculateResultIgnorable($orderState, $transactionType, $transactionState)
    {
        ...
        $handler = new Processing($this->initialProcessData);
    ...
    public function testGetNextHandler()
    {
        ...
        $this->assertEquals(new Authorization($this->initialProcessData), $result);
    }
}
